...
public class ArticleController {
     ...
     */
    @GetMapping("/{email}/articles")
    public ResponseEntity<List<ArticleConsultationDTO>> getUserArticles(@PathVariable String email) throws UserNotFoundException, IOException {
     ...
     * @throws UserNotFoundException An exception with a message that display the id of the non existing {@link User}
     */
    @GetMapping("/{email}/articles/{articleId}")
    public ResponseEntity<ArticleConsultationDTO> getUserArticleById(@PathVariable(name="email") String email, @PathVariable(name="articleId") String articleId) throws UserNotFoundException, ArticleNotFoundException {
     ...
     * @throws UserNotFoundException An exception with a message that display the id of the non existing {@link User}
     */
    @GetMapping("/{email}/articles/shared")
    public ResponseEntity<List<ArticleConsultationDTO>> getUserSharedArticles(@PathVariable String email) throws UserNotFoundException, IOException {
     ...
     * @throws UserNotFoundException An exception with a message that display the id of the non existing {@link User}
     */
    @GetMapping("/{email}/articles/shared/{articleId}")
    public ResponseEntity<ArticleConsultationDTO> getUserSharedArticleById(@PathVariable(name="email") String email, @PathVariable(name="articleId") String articleId) throws UserNotFoundException, ArticleNotFoundException {
